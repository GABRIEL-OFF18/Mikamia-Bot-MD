...
`.trim();
    ...
    let imageBuffer = await (await fetch(imagen)).buffer();
      ...
      viewOnceMessage: {
        message: {
          interactiveMessage: {
            ...
            body: { text: finalMenu },
            footer: { text: "© ᴍᴀᴅᴇ ʙʏ ᴅᴇᴠ-ꜰᴇᴅᴇxʏᴢ" },
            nativeFlowMessage: {
              buttons: [
                {
                  name: "quick_reply",
    ...
    const msg = generateWAMessageFromContent(m.chat, interactiveContent, { quoted: m });
